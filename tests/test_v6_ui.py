...
def test_backtest_ui_exposes_v9_build_and_keeps_legacy_v6_audit_locked():
    ...
    assert '2026-09-06-INSTITUTIONAL-V12.1-INDEX-VOLATILITY-RECORDER-FEASIBILITY-LAB' in (ROOT / 'RESEARCH_BUILD.txt').read_text()
...
def test_dashboard_retires_v6_production_cards_and_uses_v9_console():
    ...
    assert 'V9.4 Live F&amp;O Monitor' in html
