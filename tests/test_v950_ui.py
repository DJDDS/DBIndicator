...
def test_v950_page_preserves_v95_below_v96_primary_architecture():
    text = _html()
    assert '<strong>Research build:</strong> 2026-09-02-INSTITUTIONAL-V9.6.2-TRIAL17-PROMOTION-CONTROLS' in text
    assert '<strong>V9.6.2 Trial 17 Promotion-Control Validation is the primary research architecture.</strong>' in text
